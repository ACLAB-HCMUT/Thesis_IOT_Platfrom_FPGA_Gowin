module topmodule(
    ...
    // I2C Control Signals
    wire [15:0] temp;         // Output temperature data
    ...
    reg [31:0] uart_data; // 40 bits: 20 for humidity + 20 for temperature
    reg send_en_uart;
    wire Tx_Done;
    wire uart_state;
    ...
    reg [31:0] raw_data; // Raw data for temperature and humidity
    reg [15:0] raw_humidity;
    reg [15:0] raw_temperature;
 ...
 // Instantiate I2C Controller
    ...
    uart_data_tx #(
        .DATA_WIDTH(32), // 20-bit humidity + 20-bit temperature
        .MSB_FIRST(1)
    ) uart_inst (
        .Clk(Clk),
        .Rst_n(Rst_n),  
